...
import { colorsGivenCanvasImageSource } from "./_internal/colorsGivenCanvasImageSource";
...
export class Palette {
  ...
  static givenCanvasImageSource(
    imageSource: CanvasImageSource,
    maxColors: number
  ): Palette {
    const colors = colorsGivenCanvasImageSource(imageSource, maxColors);
    return new Palette(colors);
  }

...
export function rgbFloatGivenXyz(xyzColor: XyzColor): RgbFloatColor {
  ...
  return {
    r: Percent.givenFraction(NumberUtil.numberWithHardLimit(r, 0, 1), 1),
    g: Percent.givenFraction(NumberUtil.numberWithHardLimit(g, 0, 1), 1),
    b: Percent.givenFraction(NumberUtil.numberWithHardLimit(b, 0, 1), 1),
  };
}
